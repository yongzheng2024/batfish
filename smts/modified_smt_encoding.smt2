...
(declare-fun |0_SLICE-MAIN_as1border1_OVERALL_BEST_None_ospfType|
             ()
             (_ BitVec 2))
(declare-fun |as1border1_~OSPF_EXPORT_POLICY:default~0-prefix-length-start-0|
             ()
             Int)
...
(declare-fun |0_SLICE-MAIN_CONTROL-FORWARDING_as2border1_GigabitEthernet0/0|
             ()
             Bool)
(declare-fun as1border1_~BGP_REDISTRIBUTION~default~prefix-mask-16777472-24
             ()
             (_ BitVec 32))
(declare-fun as1border1_~BGP_REDISTRIBUTION~default~prefix-ip-16777472
             ()
             (_ BitVec 32))
(declare-fun as1border1_~BGP_REDISTRIBUTION~default~16777472-prefix-length-start-24
             ()
             Int)
(declare-fun as1border1_~BGP_REDISTRIBUTION~default~prefix-mask-16777728-24
             ()
             (_ BitVec 32))
(declare-fun as1border1_~BGP_REDISTRIBUTION~default~prefix-ip-16777728
             ()
             (_ BitVec 32))
(declare-fun as1border1_~BGP_REDISTRIBUTION~default~16777728-prefix-length-start-24
             ()
             Int)
...
(assert (let ((a!1 (and (= |0_SLICE-MAIN_as1border1_OVERALL_BEST_None_history| #b10)
                (not (and (= |0_SLICE-MAIN_as1border1_OVERALL_BEST_None_prefixLength|
                             |as1border1_~OSPF_EXPORT_POLICY:default~0-prefix-length-start-0|)
                          (= |as1border1_~OSPF_EXPORT_POLICY:default~0-prefix-length-start-0|
                             0))))))
(let ((a!2 (and (= |0_SLICE-MAIN_as1border1_OSPF_Redistributed_permitted|
                ...
                (= |0_SLICE-MAIN_as1border1_OSPF_Redistributed_ospfType|
                   (ite (= |0_SLICE-MAIN_as1border1_OVERALL_BEST_None_history|
                        ...
                        (ite a!1
                             #b11
                             |0_SLICE-MAIN_as1border1_OVERALL_BEST_None_ospfType|))))))
  (ite (or (= |0_SLICE-MAIN_as1border1_OVERALL_BEST_None_history| #b00) a!1)
       a!2
       (not |0_SLICE-MAIN_as1border1_OSPF_Redistributed_permitted|)))))
...
(assert (let ((a!1 (= (bvnot (bvor (bvnot |0_SLICE-MAIN_dst-ip|)
                           (bvnot as1border1_~BGP_REDISTRIBUTION~default~prefix-mask-16777472-24)))
              (bvnot (bvor (bvnot as1border1_~BGP_REDISTRIBUTION~default~prefix-ip-16777472)
                           (bvnot as1border1_~BGP_REDISTRIBUTION~default~prefix-mask-16777472-24)))))
      (a!2 (= (bvnot (bvor (bvnot |0_SLICE-MAIN_dst-ip|)
                           (bvnot as1border1_~BGP_REDISTRIBUTION~default~prefix-mask-16777728-24)))
              (bvnot (bvor (bvnot as1border1_~BGP_REDISTRIBUTION~default~prefix-ip-16777728)
                           (bvnot as1border1_~BGP_REDISTRIBUTION~default~prefix-mask-16777728-24))))))
(let ((a!3 (or (= |0_SLICE-MAIN_as1border1_OVERALL_BEST_None_history| #b01)
               (and (= 24
                       as1border1_~BGP_REDISTRIBUTION~default~16777472-prefix-length-start-24)
                    (= as1border1_~BGP_REDISTRIBUTION~default~16777472-prefix-length-start-24
                       24)
                    (= as1border1_~BGP_REDISTRIBUTION~default~prefix-ip-16777472
                       #x01000100)
                    (= as1border1_~BGP_REDISTRIBUTION~default~prefix-mask-16777472-24
                       #xffffff00)
                    a!1
                    (not (= |0_SLICE-MAIN_as1border1_OVERALL_BEST_None_history|
                            #b01)))
               (and (= |0_SLICE-MAIN_as1border1_OSPF_BEST_None_prefixLength|
                       as1border1_~BGP_REDISTRIBUTION~default~16777728-prefix-length-start-24)
                    (= as1border1_~BGP_REDISTRIBUTION~default~16777728-prefix-length-start-24
                       24)
                    (= as1border1_~BGP_REDISTRIBUTION~default~prefix-ip-16777728
                       #x01000200)
                    (= as1border1_~BGP_REDISTRIBUTION~default~prefix-mask-16777728-24
                       #xffffff00)
                    a!2
                    (not (= |0_SLICE-MAIN_as1border1_OVERALL_BEST_None_history|
                            #b01)))))
...
(let ((a!2 (and (= 24
                ...
                (= as1border1_~BGP_REDISTRIBUTION~default~prefix-mask-16777472-24
                   #xffffff00)
                a!1)))
(let ((a!3 (or |0_SLICE-MAIN_as1border1_OVERALL_BEST_None_community_1:2|
               (and (not a!2)
                    (= |0_SLICE-MAIN_as1border1_OVERALL_BEST_None_prefixLength|
                       0))
               (and (or a!2
               ...
               (and (or a!2
                        (= |0_SLICE-MAIN_as1border1_OVERALL_BEST_None_prefixLength|
                           24))
                    (= ((_ extract 31 8) |0_SLICE-MAIN_dst-ip|) #x030002)))))
(let ((a!4 (and (= |0_SLICE-MAIN_as1border1_BGP_EXPORT_GigabitEthernet1/0_permitted|
                   |0_SLICE-MAIN_as1border1_OVERALL_BEST_None_permitted|)
